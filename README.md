...
### 📝 범례
- SUPER_ADMIN: 관리자 (캠퍼스별 1명)
- PRE_ADMIN: 예비 운영진 (소속 캠퍼스 X)
- ADMIN: 운영진
- JOB_COORDINATOR: 잡코디네이터

- PRE_USER: 예비 학생 (소속 캠퍼스 X)
- USER: 학생
...
| 가져오기 (캠퍼스/권한/상태 변경) | ✅ | ❌ | ❌ |
| **학생 (USER)** |
| 목록 조회 (강좌별 필터링 + 검색) | ✅ | ✅ | ✅ (배정된 학생만) |
| 계정 정보 상세 조회 | ✅ | ✅ | ✅ (배정된 학생만) |
| 계정 정보 및 담당 잡코디네이터 수정 | ✅ | ❌ | ❌ |
| 강제 탈퇴 | ✅ | ❌ | ❌ |
| 강좌 정보 등록 & 조회 & 삭제 | ✅ | ❌ | ❌ |
