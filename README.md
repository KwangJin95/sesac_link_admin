...
1. 👤 회원 관리
 - 예비 운영진 목록 & 상세 조회
 - 예비 운영진 소속 캠퍼스 & 권한 변경 (PRE_ADMIN -> ADMIN 또는 JOB_COORDINATOR)
 - 소속 캠퍼스 운영진 목록 & 상세 조회
...
- 예비 학생 목록 및 상세 조회
- 예비 학생 소속 캠퍼스 & 권한 변경 (PRE_USER -> USER)
- 소속 캠퍼스 학생 목록 & 상세 조회
- 소속 캠퍼스 학생 회원 정보 수정
...
- 소속 캠퍼스 내 본인에게 배정된 학생 목록 & 상세 조회

- 본인에 대한 상담 예약 목록 & 상세 조회
- 본인에 대한 상담 예약 등록
- 본인에 대한 상담 예약 상태 변경
